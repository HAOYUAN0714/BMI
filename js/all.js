...
var BMI_submit = document.querySelector('.BMI_submit'); //增加紀錄紐
var data = JSON.parse(localStorage.getItem('BMI_record')) || [] ; //所有資訊的陣列
var BMI_record_delete = document.querySelector('.BMI_record_delete'); //刪除紀錄紐，擺在ul裡但限制點擊li才有效果
var result_return_area = document.querySelector('.result_div_hide'); //按下增加紀錄紐後要顯示的資訊跟復歸紐的設定區塊變數，默認display:none;
